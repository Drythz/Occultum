...
//=============================================================================
 /*:
 * @plugindesc v1.05a Esse plugin permite que alguns estados funcionem como
 * passivos para personagens, inimigos, e equipamentos.
 ...
 * ============================================================================
 *
 * Estados passivos são estados que são automaticamente ativos. Você pode
 * imaginá-los como uma extensão de traits mas com mais flexibilidade. Eles
 * sempre estarão lá desde que o personagem ou inimigo tenha notetags de
 * estado auto passivo.
 *
 * ============================================================================
 * Notetags
 * ============================================================================
 *
 * Notetags de Personagem, Classe, Habilidades, Arma, Armadura, Inimigo:
 *   <Passive State: x>
 *   <Passive State: x, x, x>
 *   Isso irá permitir o personagem ou inimigo a ter estado x como um
 *   estado passivo. Se colocado dentro de um notebox de arma ou armadura,
 *   o usuário terá aquele estado passivo.
 *
 *   <Passive State: x to y>
 *   Isso irá adicionar os estados x através do y (numa sequência) para o
 *   personagem ou inimigo tê-lo como um estado passivo. Se colocado dentro de
 *   um notebox de arma ou armadura, o usuário terá aquele estado passivo.
 *
